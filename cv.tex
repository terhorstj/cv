...
\documentclass[10pt]{article}
	...
	\usepackage{microtype,verbatim,soul,titling}
	\usepackage{fontspec}
...
\textbf{Laboratory Skills and Expertise:} Organic synthesis, separation (%thin-layer
TLC and column chromatography, extraction, recrystallization, distillation), characterization (GC-MS, HPLC, CE, NMR, IR, UV/Vis), computational chemistry (MM, QM, MC, MC/FEP, GB/SA). \textbf{Chemical Simulation and Visualization:} BOSS, MCPRO, Gaussian, MGL AutoDock, Spartan, Chimera, PyMol. \textbf{Productivity:} Microsoft Office, vim, GNUplot. \textbf{Programming:} Perl, FORTRAN, HTML, bash/tcsh, \LaTeX, GNUprof. \textbf{Operating Systems:} macOS, Linux (Debian/Ubuntu, Redhat/Fedora), UNIX, Windows.
